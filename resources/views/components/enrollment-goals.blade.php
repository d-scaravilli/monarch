@props(['enrollment', 'canManage' => false])
...
<x-card>
    <div class="flex items-start justify-between gap-3">
        <div>
            ...
            <p class="text-xs text-gray-400">Percorso obiettivi</p>
        </div>
        @if ($canManage)
    ...
    @if ($goals->isEmpty())
        <p class="mt-4 text-sm text-gray-500">Nessun obiettivo impostato per questo percorso.</p>
    @else
