...
<div class="space-y-3">
    <div class="relative">
        ...
        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cerca per iscritto o corso/evento..."
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-100 dark:border-white/10 text-xs font-semibold uppercase tracking-wide text-gray-400">
                        ...
                        <th class="px-5 py-3 text-left">Corso/Evento</th>
                        ...
                        <th class="px-5 py-3 text-left hidden lg:table-cell">Note</th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/10">
                    @forelse ($payments as $payment)
                        <tr wire:key="payment-{{ $payment->id }}">
                            ...
                            <td class="px-5 py-3.5 text-right font-semibold text-gray-900 dark:text-gray-100 whitespace-nowrap">€{{ number_format($payment->amount, 2) }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-5 py-8 text-center text-sm text-gray-500">Nessun pagamento registrato.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
