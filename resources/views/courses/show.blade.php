                        ...
                        x-data="{
                            async init() {
                                ...
                                const chart = new ApexCharts(this.$refs.chart, {
                                    chart: { height: 220, type: 'line', toolbar: { show: false }, zoom: { enabled: false }, fontFamily: 'inherit', foreColor: isDark ? '#9ca3af' : '#6b7280' },
                                    series: [
                                        { name: 'Presenti', type: 'column', data: {{ Illuminate\Support\Js::from(array_column($attendanceTrend, 'present')) }} },
                                        { name: 'Assenti', type: 'column', data: {{ Illuminate\Support\Js::from(array_column($attendanceTrend, 'absent')) }} },
                                        { name: 'Andamento', type: 'line', data: {{ Illuminate\Support\Js::from(array_column($attendanceTrend, 'rate')) }} },
                                    ],
